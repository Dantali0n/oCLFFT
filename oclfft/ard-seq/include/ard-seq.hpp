...
static constexpr double FOUR_PI = 4 * PI;
static constexpr double SIX_PI = 6 * PI;

//#ifdef __AVR__
static constexpr double _c1[] = {
...
public:
	/* Constructor */
	arduinoFFT(double *vReal, double *vImag, uint32_t samples, double samplingFrequency);
	/* Destructor */
	~arduinoFFT(void);
	/* Functions */
